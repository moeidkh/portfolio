  ...
  return (
    <section className="w-full h-screen pt-10 flex flex-col gap-2 overflow-y-scroll">
      <nav className="w-full flex justify-between items-center pr-16">
        <section
          key="title"
          className="flex items-center justify-center gap-2 border px-4 py-2 text-[12px] font-thin rounded-full border-gray-500"
          id="introduce"
        >
        ...
        >
          <i
            className={`fi fi-rr-apps flex items-center p-4 border-2 border-solid rounded-full border-gray-500 cursor-pointer transition-all hover:border-2 `.concat(
              hoverGenerator(color)
            )}
          ></i>
        </section>
      </nav>
      <section className="w-[80%] flex flex-col gap-12 pb-16 relative">
          ...
          <InView onChange={(inView) => inView && setActiveSection("intro")}>
            <section className="flex flex-col gap-8" id="intro">
              <section className="flex flex-col gap-8">
                <h1 className="text-[78px] font-light">
                  Say Hi from <span className={color}>Moeid</span>, Front-End
                  Developer
                </h1>
          ...
          <AnimatedTag boxVarient={boxVarient}>
            <section className="flex items-center gap-20">
              <section className="flex flex-col items-center justify-center w-fit">
                <section className={`text-[5rem] font-thin ${color}`}>
                  {calcMonth()}
                </section>
                <section className="text-gray-500 text-md text-center">
                  MONTHS OF <br />
        ...
        <AnimatedTag boxVarient={titleVarient}>
          <section
            key="title"
            className="flex items-center justify-center gap-2 border px-4 py-2 mt-28 text-[12px] font-thin rounded-full border-gray-500 w-fit"
            id="aboutTitle"
          >
            ...
            <section className="flex flex-col mb-28" id="about">
              <section className="text-gray-400 flex flex-col gap-6">
                ...
                <p className="text-justify">
                  Front-End programming is like creating a work of art that
                  brings an attractive design from a blank page and thousands of
                  users daily immerse themselves in this design. It feels great
                  to be the creator of a work that attracts thousands of views
                  daily. So, I'mmore excited than ever to take steps in this
                  path.Since the beginning of my journey in this field about 6
                  years ago until now, I have always tried to improve my skills
                  and answer other people's questions, and at one point I
                  started teaching in this field. Solving a problem is very
                  interesting. Basically, the feeling after solving a problem is
                  very sweet, so it is worth spending time on it. On the other
                  hand, I am a curious, self-confident person who is very
                  interested in music.
                </p>
              </section>
            </section>
        ...
        <AnimatedTag boxVarient={titleVarient}>
          <section
            key="title"
            className="flex items-center justify-center gap-2 border px-4 py-2 text-[12px] font-thin rounded-full border-gray-500 w-fit"
            id="resume"
          >
                ...
                >
                  <AnimatedTag boxVarient={boxVarient}>
                    <TimelineItem>
                      ...
                      <TimelineContent
                        className={`flex flex-col gap-2 transition-all duration-200 `.concat(
                          textColor(color)
                        )}
                      >
                        2022 - Present
                        <section className="h-20 mt-4 flex flex-col gap-1">
                          <h1 className="text-lg">
                            Front-End Development Instructor | Web Design
                            Workshop
                          </h1>
                    ...
                    <TimelineItem>
                      ...
                      >
                        ...
                        <section className="h-16 mt-4 flex flex-col gap-1">
                          ...
                          <p className="text-[0.75rem] text-gray-500">
                            <a
                              href="https://www.linkedin.com/company/pdei"
                              target="_blank"
                            >
                              Iranian Data Support
                            </a>
                          </p>
                        </section>
                      </TimelineContent>
              ...
              <section className="w-full flex flex-wrap gap-8">
                <AnimatedTag boxVarient={boxVarient}>
                  <section className="flex flex-col items-center justify-center gap-6">
                    <section
                      key="icon"
                      className={`w-32 px-8 py-12 transition-all duration-150 border-2 border-gray-500 rounded-full flex flex-col items-center gap-4 justify-center text-[90px] `.concat(
                        borderColor(color)
                      )}
                    >
                      <a href="https://react.dev/" target="_blank">
                        <i className="fab fa-react flex items-center justify-center"></i>
                      </a>
                    </section>
                    <p>React.js</p>
                  </section>
                  ...
                  <section className="flex flex-col items-center justify-center gap-6">
                    ...
                    >
                      <a href="https://www.typescriptlang.org/" target="_blank">
                        <i className="fi fi-brands-typescript flex items-center justify-center"></i>
                      </a>
                    </section>
                    <p>TypeScript</p>
                  </section>
                ...
                <AnimatedTag boxVarient={boxVarient}>
                  ...
                  >
                    <section className="w-full h-96 flex items-end pb-2 pl-2 gap-2 sample1 bgConf bg-cover rounded-xl cursor-pointer">
                      <section className="border border-gray-500 bg-gray-700 w-fit px-4 p-2 flex items-center justify-center rounded-full h-fit">
                        React
                      </section>
                      <section className="border border-gray-500 bg-gray-700 w-fit px-4 p-2 flex items-center justify-center rounded-full h-fit">
                        HTML
