...
export const styles = stylex.create({
  ...
  menuContainer: {
    width: { default: "35%", [breakpoints.md]: "100%" },
    height: { default: "100vh", [breakpoints.md]: "100dvh" },
    backgroundColor: variables["gray-900"],
    direction: "ltr",
    display: "flex",
    flexDirection: "column",
    justifyContent: { default: "center", [breakpoints.md]: "flex-start" },
    paddingTop: { default: "unset", [breakpoints.md]: "7rem" },
    alignItems: "center",
    gap: "3rem",
  },
  menuTitle: {
    fontSize: { default: "2.25rem", [breakpoints.md]: "2.5rem" },
    lineHeight: "2.5rem",
  },
  menuItem: {
    padding: "0.25rem",
  ...
  menu: {
    width: { default: "100%", [breakpoints.md]: "80%" },
    display: "flex",
    flexWrap: "wrap",
  ...
  backgroundOptionWrapper: {
    display: "flex",
    flexDirection: "column",
    alignItems: { default: "unset", [breakpoints.md]: "center" },
    gap: "2rem",
  },
  backgroundOptionTitle: {
    fontSize: { default: "1.25rem", [breakpoints.md]: "1.5rem" },
    lineHeight: "1.75rem",
    paddingLeft: { default: "unset", [breakpoints.md]: "1rem" },
    paddingTop: { default: "unset", [breakpoints.md]: "1rem" },
    fontWeight: "600",
  },
  backgroundOptionsContainer: {
    ...
    gap: {default: "2rem", [breakpoints.md]: "1rem"},
    fontSize: "0.875rem",
    lineHeight: "1.25rem",
    width: { default: "100%", [breakpoints.md]: "80%" },
  },
  backgroundOption: {
    ...
    padding: {default:"0.5rem", [breakpoints.md]: "0.75rem"},
